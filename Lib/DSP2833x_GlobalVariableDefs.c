...
//-------------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION(" SRAM_BUFFER ")
#else
#pragma DATA_SECTION(SRAM_ZONE1Regs," SRAM_BUFFER ");
#endif
//volatile struct SRAM_ZONE1_REGS SRAM_ZONE1Regs;

//-------------------------------------------
#ifdef __cplusplus
#pragma DATA_SECTION("SRAM_RECORD ")
#else
#pragma DATA_SECTION(SRAM_ZONE2Regs,"SRAM_RECORD ");
#endif
//volatile struct SRAM_ZONE2_REGS SRAM_ZONE2Regs;

//-------------------------------------------
/*#ifdef __cplusplus
#pragma DATA_SECTION("SRAM_ZONE3DATA")
#else
#pragma DATA_SECTION(SRAM_ZONE3Regs,"SRAM_ZONE3DATA");
#endif
//volatile struct SRAM_ZONE3_REGS SRAM_ZONE3Regs;*/

//-------------------------------------------
/*#ifdef __cplusplus
#pragma DATA_SECTION("SRAM_ZONE4DATA")
#else
#pragma DATA_SECTION(SRAM_ZONE4Regs,"SRAM_ZONE4DATA");
#endif
//volatile struct SRAM_ZONE4_REGS SRAM_ZONE4Regs;*/
